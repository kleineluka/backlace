Shader "luka/backlace/small/outline"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Stencil
            {
                Ref [_OutlineStencilRef] Comp [_OutlineStencilComp] Pass [_OutlineStencilPass] Fail [_OutlineStencilFail] ZFail [_OutlineStencilZFail]
            }
            CGPROGRAM
            #ifndef UNITY_PASS_OUTLINE
                #define UNITY_PASS_OUTLINE
            #endif // UNITY_PASS_OUTLINE
            #include "./Variants/Backlace_SmallOutline.cginc"
