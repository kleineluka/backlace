...
namespace Luka.Backlace
{
    ...
    public class Interface : ShaderGUI
    {
        ...
        public void load(ref Material targetMat)
        {
            ...
            sub_tab_stocking = new Tab(ref targetMat, ref theme, (int)Tab.tab_sizes.Sub, 3, languages.speak("sub_tab_stocking"), null, "_ToggleStocking");
            ...
            sub_tab_translucent_hair = new Tab(ref targetMat, ref theme, (int)Tab.tab_sizes.Sub, 5, languages.speak("sub_tab_translucent_hair"), null, "_ToggleTranslucentHair");
        ...
        private void DrawUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            tab_stickers.process(() => {
                ...
                materialEditor.ShaderProperty(prop_DecalStage, languages.speak("prop_DecalLighting"));
