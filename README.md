...
- [UmaShader](https://github.com/Sneppys/UmaShader), [Arc Systems Work for Unity](https://github.com/Aerthas/UNITY-Arc-system-Works-Shader), and [HoyoToon](https://github.com/Hoyotoon/HoyoToon?) were referenced for what packed texture channels contain for their respective models. All are under the GPLv3 license.
