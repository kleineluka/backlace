...
namespace Luka.Backlace
{
    ...
    public class Announcement
    {
        ...
        public void draw()
        {
            ...
            if (theme.metadata_manager.full_metadata == null) return; // metadata not loaded
    ...
    public class LicenseMenu
    {
        ...
        // basic constructor
        public LicenseMenu(ref Theme theme, ref Languages languages, ref Tab tab)
        {
            this.theme = theme;
            this.languages = languages;
            this.tab = tab;
        ...
        public void draw()
        {
            if (Project.has_license == false) return; // no license, no menu
            tab.draw();
            if (tab.is_expanded)
            {
                Components.start_foldout();
                ...
                {
                    string license_path = Project.project_path + Project.project_license;
    ...
    public class Docs
    {
        ...
        public void draw()
        {
            if (Project.has_docs == false) return; // no docs, no menu
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.BeginVertical();
